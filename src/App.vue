  ...
  <div class="container">
    ...
    >
      <a
        ...
        @click="(isCartVisible = false), (isWhishListVisible = false)"
        >Books</a
      >
      <div class="d-flex align-items-baseline">
        ...
        <button
          ...
          @click="(isWhishListVisible = true), (isCartVisible = false)"
        >
          My WishList
        </button>
      </div>
      <div class="d-flex align-items-baseline">
        ...
        <button
          ...
          @click="(isWhishListVisible = false), (isCartVisible = true)"
        >
          Show Cart
        </button>
      </div>
    ...
    <!-- banner -->
    <template v-if="isCartVisible == false && isWhishListVisible == false">
      <homeComponent
        :books="books"
        @addToWishListBtnClicked="addToWishList"
        @addToChartBtnClicked="addToChart"
      />
    </template>
    <template v-if="isCartVisible">
      <cartComponent :cartContent="cart.items" />
    </template>
    <template v-if="isWhishListVisible">
      <wishingListComponent :listContent="whishList.whishListItems" />
    </template>
  </div>
</template>
